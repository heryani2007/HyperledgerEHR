...
const {logWho} = require('./transferPatientRecordOrg2');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org2MSP', who, 'Fail to Transfer User', currentTime, logWho.account,);
