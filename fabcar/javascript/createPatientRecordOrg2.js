...
async function main() {
  ...
  module.exports = { logWho };
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailCreatePatientOrg2.js'); // Include create_log.js
            return;
        }
        ...
        await contract.submitTransaction('createCar', carNumber+'Org2MSP', 'Org2MSP', name+'Org2', patient_ID, primary_care_doctor, date_of_birth, gender, address, insurance, prescription, allergies);
        console.log('Transaction has been submitted');
        
        const { createLog } = require('./createAuditRecordCreateOrg2'); // Include create_log.js
