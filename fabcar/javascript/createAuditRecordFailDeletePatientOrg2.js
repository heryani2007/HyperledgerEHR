...
const {logWho} = require('./deletePatientRecordOrg2');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org2MSP', who, 'Fail to Delete Patient Record', currentTime, logWho.account,);
