...
const {logWho} = require('./getAuditRecordSpecificOrg3.js');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org3MSP', who, 'Query Audit Records', currentTime, who,);
