  ...
  module.exports = { logWho };
       ...
       rl.close(); // Close the readline interface
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailDeletePatientOrg3.js'); // Include create_log.js
            return;
        }
        ...
        await contract.submitTransaction('deleteCar', carNumberToDelete+'Org3MSP');
        console.log(`Car with number ${carNumberToDelete} has been deleted`);
        const { createLog } = require('./createAuditRecordDeleteOrg3'); // Include create_log.js
