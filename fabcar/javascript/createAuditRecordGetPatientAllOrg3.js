...
const {logWho} = require('./getPatientRecordAllOrg3');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org3MSP', who, 'Query Patient Records', currentTime, 'Org3 - All',);
