...
const {logWho} = require('./registerInputOrg2');
...
async function main() {
    try {
        ...
        const who = identity ? 'adminOrg2' : 'adminOrg2';
        if (!identity) {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org2MSP', who, 'Register', currentTime, logWho.patient_id,);
