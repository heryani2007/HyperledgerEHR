...
const {logWho} = require('./getAuditRecordSpecificOrg1.js');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Query Audit Records', currentTime, who,);
