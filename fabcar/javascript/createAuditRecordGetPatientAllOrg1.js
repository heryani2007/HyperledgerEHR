...
const {logWho} = require('./getPatientRecordAllOrg1');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Query Patient Records', currentTime, 'Org1 - All',);
