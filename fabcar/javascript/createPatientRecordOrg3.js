...
async function main() {
    try {
        ...
        const carNumber = await new Promise((resolve) => {
            rl.question('Enter the record number you want to assign the patient: ', (carNumber) => {
                resolve(carNumber);
  ...
  module.exports = { logWho };
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailCreatePatientOrg3.js'); // Include create_log.js
            return;
        }
        ...
        await contract.submitTransaction('createCar', carNumber+'Org3MSP', 'Org3MSP', name+'Org3', patient_ID, primary_care_doctor, date_of_birth, gender, address, insurance, prescription, allergies);
        console.log('Transaction has been submitted');
        
        const { createLog } = require('./createAuditRecordCreateOrg3'); // Include create_log.js
