...
const {logWho} = require('./transferPatientRecordOrg1');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Fail to Transfer User', currentTime, logWho.account,);
