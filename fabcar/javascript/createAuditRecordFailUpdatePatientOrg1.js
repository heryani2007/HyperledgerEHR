...
const {logWho} = require('./updatePatientRecordOrg1');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Fail to Update Patient Record', currentTime, logWho.account,);
