...
//const { createLog } = require('./queryEHR+log'); // Include create_log.js
...
async function main() {
  ...
  module.exports = { logWho };
        ...
        const filteredResults = allResults.filter((record) => record.Record.mspID === 'Org2MSP');

        console.log(`Transaction has been evaluated, result is:`);
        console.log(filteredResults);
        const { createLog } = require('./createAuditRecordGetPatientAllOrg2'); // Include create_log.js        
