...
const newCarNumberTrimmed = newCarNumber.slice(0, -3);
  ...
  module.exports = { logWho };
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailTransferPatientOrg2'); // Include create_log.js
            return;
        }
        ...
        await contract.submitTransaction('transferCar', oldCarNumber+'Org2MSP', newCarNumber, newCarNumberTrimmed);
        console.log('Transaction has been submitted');
        
        const { createLog } = require('./createAuditRecordTransferOrg2'); // Include create_log.js
