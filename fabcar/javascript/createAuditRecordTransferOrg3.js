...
const {logWho} = require('./transferPatientRecordOrg3');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org3MSP', who, 'Transfer', currentTime, logWho.patient_id,);
