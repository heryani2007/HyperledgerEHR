...
async function main() {
  ...
  module.exports = { logWho };
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailGetPatientOrg1'); // Include create_log.js
            return;
        }
        ...
        const filteredResults = allResults.filter((record) => record.Record.name === user+'Org1');

        console.log(`Transaction has been evaluated, result is:`);
        console.log(filteredResults);
        const { createLog } = require('./createAuditRecordGetPatientSpecificOrg1'); // Include create_log.js
