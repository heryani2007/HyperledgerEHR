...
const {logWho} = require('./deletePatientRecordOrg1');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Fail to Delete Patient Record', currentTime, logWho.account,);
