...
const {logWho} = require('./getPatientRecordAll');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Query Patient Records', currentTime, 'Org1/2/3 - All',);
