...
const {logWho} = require('./createPatientRecordOrg2');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org2MSP', who, 'Failed to Create Patient Record', currentTime, logWho.account,);
