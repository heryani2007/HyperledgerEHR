  ...
  module.exports = { logWho };
    ...
    allergies: allergies
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailUpdatePatientOrg1'); // Include create_log.js
            return;
        }
        ...
        //await contract.submitTransaction('updateCar', carNumber, 'Org1MSP', name, patient_ID, primary_care_doctor, date_of_birth, gender, address, insurance, prescription, allergies);
        await contract.submitTransaction('updateCar', carNumber+'Org1MSP', JSON.stringify(updates));
        console.log('Transaction has been submitted');
        
        const { createLog } = require('./createAuditRecordUpdateOrg1'); // Include create_log.js
