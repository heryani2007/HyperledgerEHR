  ...
  module.exports = { logWho };
       rl.close(); // Close the readline interface
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailDeletePatientOrg2'); // Include create_log.js
            return;
        }
        ...
        await contract.submitTransaction('deleteCar', carNumberToDelete+'Org2MSP');
        console.log(`Record with number ${carNumberToDelete} has been deleted`);
        const { createLog } = require('./createAuditRecordDeleteOrg2'); // Include create_log.js
