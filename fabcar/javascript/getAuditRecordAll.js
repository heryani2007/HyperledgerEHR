...
//const { createLog } = require('./createAuditRecordGetAuditAll'); // Include create_log.js
...
async function main() {
  ...
  module.exports = { logWho };
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailGetAuditOrg1'); // Include create_log.js
            return;
        }
