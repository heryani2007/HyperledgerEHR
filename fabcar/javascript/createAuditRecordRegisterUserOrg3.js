...
const {logWho} = require('./registerInputOrg3');
...
async function main() {
    try {
        ...
        const who = identity ? 'adminOrg3' : 'adminOrg3';
        if (!identity) {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org3MSP', who, 'Register', currentTime, logWho.patient_id,);
