...
const {logWho} = require('./updatePatientRecordOrg2');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org2MSP', who, 'Fail to Update Patient Record', currentTime, logWho.account,);
