...
async function main() {
  ...
  module.exports = { logWho };
        ...
        const filteredResults = allResults.filter((record) => record.Record.who === user+'Org3');

        console.log(`Transaction has been evaluated, result is:`);
        console.log(filteredResults);

        const { createLog } = require('./createAuditRecordGetAuditSpecificOrg3.js'); // Include create_log.js
