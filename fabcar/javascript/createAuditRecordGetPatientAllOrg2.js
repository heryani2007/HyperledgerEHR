...
const {logWho} = require('./getPatientRecordAllOrg2');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org2MSP', who, 'Query Patient Records', currentTime, 'Org2 - All',);
