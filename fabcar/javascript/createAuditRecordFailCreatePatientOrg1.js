...
const {logWho} = require('./createPatientRecordOrg1');
...
async function main() {
    try {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Failed to Create Patient Record', currentTime, logWho.account,);
