...
async function main() {
  ...
  module.exports = { logWho };
            ...
            const userIdentity = await wallet.get(userID+'Org3');
            if (userIdentity) {
            ...
            await wallet.put(userID+'Org3', x509Identity);
            console.log(`Successfully registered and enrolled admin user "${userID}" and imported it into the wallet`);

        //});
        const { createLog } = require('./createAuditRecordRegisterUserOrg3.js'); // Include create_log.js createAuditRecordRegisterUserOrg1.js
