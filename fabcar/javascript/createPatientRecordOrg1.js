...
async function main() {
  ...
  module.exports = { logWho };
        ...
        if (!identity) {
            ...
            const { createLog } = require('./createAuditRecordFailCreatePatientOrg1.js'); // Include create_log.js
            return;
        }
        ...
        await contract.submitTransaction('createCar', carNumber+'Org1MSP', 'Org1MSP', name+'Org1', patient_ID, primary_care_doctor, date_of_birth, gender, address, insurance, prescription, allergies);
        console.log('Transaction has been submitted');
        
        const { createLog } = require('./createAuditRecordCreateOrg1'); // Include create_log.js
