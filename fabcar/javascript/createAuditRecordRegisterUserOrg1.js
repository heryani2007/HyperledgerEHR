...
const {logWho} = require('./registerInputOrg1');
...
async function main() {
    try {
        ...
        const who = identity ? 'adminOrg1' : 'adminOrg1';
        if (!identity) {
        ...
        await contract.submitTransaction('createCar', currentTime, 'Org1MSP', who, 'Register', currentTime, logWho.patient_id,);
